...
function createPageComposer (playbook, contentCatalog, uiCatalog) {
  ...
  uiCatalog
    ...
    .forEach(({ stem, contents }) => {
      const filename = ospath.join(playbook.dir ?? '.', 'ui-helpers', stem + '.js')
      handlebars.registerHelper(stem, requireFromString(contents.toString(), filename))
    })
